class TodoList {
    ...
    initiateEventListeners() { 
        this.buttonInput.addEventListener('click', (event) => this.clickButton(event));
        ...
        this.itemList.addEventListener('dragover', (event) => this.handleDragOver(event));
        this.itemList.addEventListener('drop', (event) => this.handleDrop(event));
        this.itemList.addEventListener('dragend', (event) => this.handleDragEnd(event));
